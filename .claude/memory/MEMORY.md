...
- [開発プロセスの置き場所と2ルート運用](dev-process-structure.md) — docs/processがSSOT、AGENTS.mdが入口、.claudeは呼び出し口。基盤整備計画はdocs/plans/2026-09-16-dev-process-foundation.md（C2以降はユーザー判断待ち）
