...
カードとデッキの詳細は [カード・デッキの考え方](card-and-deck.md)、場・手札・プレイの詳細は [場・手札・プレイ](play-and-field.md)、裏表の扱いは [カードの裏表](card-face-back.md)、グラフの役割の詳細は [グラフの役割](graph.md)、段階的な開示の仕組みは [段階的な開示・習熟によるアンロック](unlock.md) を参照。
